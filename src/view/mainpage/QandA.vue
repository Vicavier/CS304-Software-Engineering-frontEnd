...
export default {
  ...
  setup(){
    const QAList = reactive([
      ...
      //   gmt_create:'',
      //   gmt_modified:'',
      //   avatar_url:'https://avatars.githubusercontent.com/u/91972567?v=4',
      // },
      {
        id:1,
        ...
        likes:23,
        poster:'YUKI',
        avatar_url:'https://avatars.githubusercontent.com/u/83950900?s=96&v=4'
      },{
        id:5,
        ...
        likes:90,
        poster:'老马脚臭害我口腔溃疡',
        avatar_url:'http://image.woshipm.com/wp-files/2021/07/FjWhCgCnNTa8ktefVqSa.jpeg'
      },])
    function toHomePage(){
      router.push('/')
    }
